...
- **inquiry_tasks** 테이블: 인콰이어리 할일 (inquiryId FK→inquiries, content, completed boolean, dueDate YYYY-MM-DD nullable, createdAt YYYY-MM-DD) - 인콰이어리별 할일/체크리스트 관리, 대시보드에서 전체 미완료 할일 모아보기
