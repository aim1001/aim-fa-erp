...
- **quotations** 테이블: 견적서 (inquiryId FK→inquiries, quoteNumber, quoteDate, validUntil, notes, status draft/sent/accepted, adjustmentAmount, adjustmentNote, discountType(amount고정), discountValue(할인금액), discountTruncUnit(none/1000/10000/100000/1000000 - 최종공급가액에 절사 적용), createdAt)
